...
$(document).ready(function(){
	...
	searchleave = $("#namelist").val();
    $.ajax({
		  url: '/leavesystem/Users/searchleaveyl/'+searchleave,
...
<div class="container ">
    <div class="well">
      <h2>चालू वर्षातील घेतलेल्या रजा</h2>
        <span class="aa">नैमित्तिक / किरकोळ रजा:</span><span class="badge shownotification"><?= h($user->yearly_cl_taken) ?></span>
        <span class="aa">अर्जित रजा:</span><span class="badge shownotification"><?= h($user->yearly_el_taken) ?></span>
        <span class="aa">वैद्यकीय रजा:</span><span class="badge shownotification"><?= h($user->yearly_ml_taken) ?></span>
        <br/><br/>
		 <div class="col-md-12 col-lg-12 well">
			 ...
			 <div class="col-xs-10 col-sm-6 col-md-4 col-lg-4 pull-right">
                                 ...
                                 <select name="namelist" id="namelist" class="form-control" style="text-align:center;" >
